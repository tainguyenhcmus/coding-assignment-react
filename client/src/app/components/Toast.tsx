...
const Toast: React.FunctionComponent<IToastProps> = ({ message, duration, onClose, status }) => {
  ...
  return visible ? <div className="fixed bottom-4 flex items-center w-full max-w-xl p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert" >
